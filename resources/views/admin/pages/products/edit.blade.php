        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            ...
            <div class="mb-3">
              ...
              <input value="{{ $product->name }}" name="name" type="text" class="form-control" id="productName"
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="productStatus" name="is_sales">
                <option value="" {{ $product->is_sales === null ? 'selected' : '' }}>Mặc định</option>
                <option value="0" {{ $product->is_sales === 0 ? 'selected' : '' }}>Ngừng bán</option>
                <option value="1" {{ $product->is_sales === 1 ? 'selected' : '' }}>Đang bán</option>
                <option value="2" {{ $product->is_sales === 2 ? 'selected' : '' }}>Hết hàng</option>
              </select>
          ...
          <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
            ...
            <div class="border text-center">
              <img class="img-fluid img-thumbnail" id="fileUploadPreview"
                src="{{ $product->image ? url('') . '/' . $product->image : 'https://via.placeholder.com/400?text=Product%20Image' }}"
            ...
            <div class="d-flex flex-wrap gap-3 align-items-center justify-content-center mt-3">
              ...
              <input id="fileUploadImageName" class="input-group-text flex-grow-1" type="text" disabled
                value="{{ explode('/', $product->image)[2] ?? 'Tên file upload' }}">
              <input name="imageName" id="fileUploadImageNameHidden" type="hidden"
                value="{{ explode('/', $product->image)[2] ?? 'Tên file upload' }}">
            </div>
    ...
    <script>
      ...
      $('#fileUpload').on('change', event => {
        ...
        if (file) {
          ...
          $('#fileUploadImageNameHidden').val(imageName);
      ...
      $('#clearFileUpload').on('click', event => {
        ...
        $('#fileUploadImageNameHidden').val(null); // clear name of file hidden
